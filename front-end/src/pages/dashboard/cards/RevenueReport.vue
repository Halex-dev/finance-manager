  ...
  <template v-else>
    <VaCard class="flex flex-col">
      <VaCardTitle class="flex items-start justify-between">
        <h1 class="card-title text-secondary font-bold uppercase">{{ t('dashboard.revenue.title') }}</h1>
      ...
      <VaCardContent class="flex flex-col-reverse md:flex-row md:items-center justify-between gap-5 h-full">
        <section class="flex flex-col items-start w-full sm:w-1/3 md:w-2/5 lg:w-1/4 gap-2 md:gap-8 pl-4">
          <div>
            ...
            <p class="whitespace-nowrap mt-2">{{ t('dashboard.revenue.total') }}</p>
          </div>
          <div class="flex flex-col sm:flex-col gap-2 md:gap-8 w-full">
            <div>
              <div class="flex items-center">
                ...
                <span class="text-secondary">{{ t('dashboard.revenue.earning') }}</span>
              </div>
            ...
            <div>
              <div class="flex items-center">
                ...
                <span class="text-secondary">{{ t('dashboard.revenue.expense') }}</span>
              </div>
